...
-- Headless Neovim semantic probe derived from GoodNotes code shapes.
--
-- Checks:
...
local root = arg[1]
assert(root and root ~= "", "usage: nvim -l dev/nvim_goodnotes_semantic.lua <project-dir> [ktlsp-bin]")
...
check("GoodNotes semantic probe warmed", ready)
