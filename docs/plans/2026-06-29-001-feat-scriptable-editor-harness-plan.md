...
- `dev/nvim_gradle_live.lua` and `dev/nvim_comprehensive.lua` hardcode
  `/Users/pepe/projects/github.com/pepegar/ktlsp`, so they do not naturally exercise this worktree.
...
- `docs/plans/2026-06-08-001-feat-diagnostics-backend-bench-harness-plan.md` and
  `docs/plans/2026-06-09-001-feat-kotlin-daemon-backend-plan.md` establish the existing separation:
  backend latency/oracle lives in `bench`, while editor correctness belongs in Neovim-based smoke
  tests.
...
**Verification:** No Neovim probe contains `/Users/pepe/projects/github.com/pepegar/ktlsp` after the
change.
...
- Related docs: `README.md`, `docs/plans/2026-06-08-001-feat-diagnostics-backend-bench-harness-plan.md`,
  `docs/plans/2026-06-09-001-feat-kotlin-daemon-backend-plan.md`
